        ...
        <div class="container-fluid h-100 d-flex justify-content-center  align-items-center" >
            <div class="row align-items-center justify-content-center justify-content-xl-start">
                <div class="col-lg-5 ps-0 d-none d-xl-block position-relative">
                    <img src="<?php echo e(asset('frontend_assets/img/signup-image.png')); ?>" alt="" class="mg-fluid w-100 login-left-img">
                ...
                <div class="col-xl-5 col-lg-7 offset-xl-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-5 mb-4">
                            <button type="submit" class="btn-submit-login border-0"><?php echo e(__('Register')); ?></button>
                        </div>
                        <div class="col-12">
                            <p class="text-white">Already a member? <a href="<?php echo e(route('login')); ?>" style="color: #feb34e;">Sign In</a></p>
                        </div>
                    </div>
                    </form>
                </div>
...
</html><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/auth/register.blade.php ENDPATH**/ ?>