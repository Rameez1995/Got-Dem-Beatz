<?php $__env->startSection('page_title', 'Producers'); ?>
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="<?php echo e(url('/admin/producer/add')); ?>" class="btn btn-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="../storage/producers/<?php echo e($producer->image); ?>" width="100px" height="50px"></td>
                    <td><?php echo e(Str::limit($producer->desc, 100)); ?></td>
                    <td>
                    ...
                    <td style="width: 11rem">
                      ...
                      <a href="<?php echo e(url('/admin/producer/edit/'.$producer->id)); ?>" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="<?php echo e(url('/admin/producer/delete/'.$producer->id)); ?>" class="btn btn-danger btn-sm"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/admin/producers/index.blade.php ENDPATH**/ ?>