          ...
          <div class="card">
            <div class="card-header">
              ...
              <!-- <div class="card-tools">
                <a href="<?php echo e(url('/admin/service/add')); ?>" class="btn btn-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="../storage/services/<?php echo e($service->image); ?>" width="100px" height="50px"></td>
                    <td><?php echo e(Str::limit($service->desc, 100)); ?></td>
                    <td>
                    ...
                    <td style="width: 11rem">
                      <a href="<?php echo e(url('/admin/service/edit/'.$service->id)); ?>" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="<?php echo e(url('/admin/service/delete/'.$service->id)); ?>" class="btn btn-danger btn-sm"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/admin/services/index.blade.php ENDPATH**/ ?>