<?php $__env->startSection('page_title', 'Songs'); ?>
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Manage Beats</h3>
              <div class="card-tools">
                <a href="<?php echo e(url('/admin/song/add')); ?>" class="btn btn-primary">
                  <i class="fa fa-user mr-2"></i> Add new beat
                </a>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <table id="" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="../storage/songs/<?php echo e($song->image); ?>" width="100px" height="50px"></td>
                    <td><?php echo e(Str::limit($song->desc, 100)); ?></td>
                    <td><?php echo e($song->sorting); ?></td>
                    
                    <td><audio controls>
                    <source src="../storage/songs/<?php echo e($song->song_file); ?>" type="audio/ogg">
                    <source src="../storage/songs/<?php echo e($song->song_file); ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                    </audio></td>
                    <td>
                      <?php if($song->status == 1): ?>
                    ...
                    <td style="width: 11rem">
                      <a href="<?php echo e(url('/admin/song/edit/'.$song->id)); ?>" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="<?php echo e(url('/admin/song/delete/'.$song->id)); ?>" class="btn btn-danger btn-sm"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/admin/songs/index.blade.php ENDPATH**/ ?>