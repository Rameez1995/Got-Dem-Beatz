            ...
            <form action="<?php echo e(secure_url('/admin/web-setting/'.$webSettings->id)); ?>" method="POST"
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <figure class="figure">
                    <img src="<?php echo e(url('/storage/settings/logo/'.$webSettings->logo)); ?>"
                 ...
                 <div class="form-group">
                  <label for="inputFile">Banner</label><br>
                  <figure class="figure">
                    <img src="<?php echo e(url('/storage/settings/banner/'.$webSettings->banner)); ?>"
                      class="figure-img img-fluid rounded img-thumbnail" alt="Banner photo" width="300">
                  </figure>
                  <input type="file" name="banner" class="form-control" id="inputFile">
                  <input type="hidden" name="banner2" value="<?php echo e($webSettings->banner); ?>">
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/admin/web_setting/edit.blade.php ENDPATH**/ ?>