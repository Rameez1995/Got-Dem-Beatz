                            ...
                            <div class="table-responsive my-4 text-white">
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $songs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td><?php echo e(Str::limit($song->desc, 40)); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/front/songs/my_songs.blade.php ENDPATH**/ ?>