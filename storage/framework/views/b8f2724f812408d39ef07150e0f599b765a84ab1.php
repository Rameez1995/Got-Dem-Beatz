                                ...
                                <div class="col-lg-10">
                                    ...
                                    <ul class="setting-nav">
                                        <li class="border-bottom pb-3 mb-3">
                                            <a href="<?php echo e(route('user.edit_profile')); ?>" class="d-inline-flex align-items-center text-white">
                                        ...
                                        <li class="border-bottom pb-3 mb-3">
                                            <a href="<?php echo e(route('user.get_password')); ?>" class="d-inline-flex align-items-center text-white">
                                        ...
                                        <li class="border-bottom pb-3 mb-3">
                                            <a href="<?php echo e(route('user.cards')); ?>" class="d-inline-flex align-items-center text-white">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/dashboard/front/settings/index.blade.php ENDPATH**/ ?>