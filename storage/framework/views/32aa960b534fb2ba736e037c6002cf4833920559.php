                        ...
                        <div class="my-4 table-responsive track-list">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr valign="">
                                        <td class="td_size ">
                                            <img src="../storage/songs/<?php echo e($song->image); ?>" class="img-fluid" alt="" width="60px" height="50">
                                        <button class="border-0 play-pause-button py-2 px-2 bg-transparent position-relative" value="<?php echo e($song->song_file); ?>" 
                                        ...
                                        <td class="td_size"></td>
                                        <?php endif; ?>
                                        <td class="text-center none-mobile"><?php echo e($song->min); ?>:<?php echo e($song->sec); ?></td>
                                        <td class="text-center none-mobile"><?php echo e($song->bpm); ?></td>
                                        <td class="tag td_size none-mobile">
                                            <?php $__currentLoopData = $song->song_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tags): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="./tags/<?php echo e($tags->tags); ?>" class="border py-2 px-3 d-inline-block" href="javscript:void(0)"><?php echo e($tags->tags); ?>.</a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/beatpro/resources/views/pages/song.blade.php ENDPATH**/ ?>