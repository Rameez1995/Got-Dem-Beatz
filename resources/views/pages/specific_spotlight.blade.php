            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 text-center mb-3 mb-lg-0">
                        <img src="../storage/spotlights/{{ $spotlight->image }}" width="350px" height="400px">
                    </div>
                    <div class="col-lg-5">
                        <div class="py-4" id="waveform"></div>
                        <h2 class="fs-1 text-uppercase after-none py-0">{{$spotlight->name}}</h2>
                        <div id="hello">
                        <button id="box"  class="btn-1 d-block text-center text-white text-decoration-none" type="submit" class="" value="{{ $spotlight->song_file }}" 
                                         onclick="dosomething(this);return false;">Play/Pause</button></div>
                        <p class="py-md-3 py-2">{!!$spotlight->desc!!}</p>
                    </div>
                </div>
            </div>
        </section>
