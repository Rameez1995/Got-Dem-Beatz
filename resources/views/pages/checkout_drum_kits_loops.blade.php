@extends('layout')
@section('title', 'Checkout Drum Kits / Loops')
@section('content')
<section class="banner_inner d-flex justify-content-center align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="banner_inner_title">Place an Order</h1>
                    </div>
                </div>
            </div>
</section>
                    ...
                    <div class="col-12">
                        <div class="bg-white shadow rounded">
                            <div class="py-3" style="background-color: #000;">
                                <h2 class="text-white fs-4 mb-0 ps-5">Place an Order</h2>
                            </div>
                            <div class="row py-lg-5">
                                ...
                                <div class="col-lg-6">
                                    <div class="bg-white shadow rounded px-lg-5 pb-lg-5 me-lg-5 px-5 pb-4">
                                        ...
                                        <h3 class="fs-5 mb-4">Drum Kits / Loops</h3>
                                        <div class="row gy-2">
                                            <div class="col-sm-6">{{ $drum_kit_loop->title }}</div>
                                            <div class="col-sm-6 text-end">${{ $drum_kit_loop->price }}</div>
                                        </div>
                                        ...
                                        <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{!! URL::route('pay_drum_kits_loops') !!}" >
                                        {{ csrf_field() }}
                                        <input id="amount" type="hidden" class="form-control" name="amount" value="{{ $drum_kit_loop->price }}" autofocus>
                                        <input id="drum_kit_loop_id" type="hidden" class="form-control" name="drum_kit_loop_id" value="{{ $drum_kit_loop->id }}" autofocus>
