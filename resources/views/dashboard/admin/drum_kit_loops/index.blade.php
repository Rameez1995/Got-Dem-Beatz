...
@section('page_title', 'Drum Kits / Loops')
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{ url('/admin/drum_kits_loops/add') }}" class="btn btn-primary">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ Str::limit($drum_kit_loop->desc, 100) }}</td>
                    <td>{{ $drum_kit_loop->strikethrough_price }}$</td>
                    <td>{{ $drum_kit_loop->price }}$</td>
                    <td>
                      @if ($drum_kit_loop->status == 1)
                    ...
                    <td style="width: 11rem">
                      ...
                      <a href="{{ url('/admin/drum_kits_loops/edit/'.$drum_kit_loop->id) }}" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="{{ url('/admin/drum_kits_loops/delete/'.$drum_kit_loop->id) }}" class="btn btn-danger btn-sm"><i
