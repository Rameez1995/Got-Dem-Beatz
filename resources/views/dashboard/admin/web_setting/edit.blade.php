            ...
            <form action="{{ secure_url('/admin/web-setting/'.$webSettings->id) }}" method="POST"
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <figure class="figure">
                    <img src="{{ url('/storage/settings/logo/'.$webSettings->logo) }}"
                 ...
                 <div class="form-group">
                  ...
                  <figure class="figure">
                    <img src="{{ url('/storage/settings/banner/'.$webSettings->banner) }}"
                  ...
                  <input type="hidden" name="banner2" value="{{ $webSettings->banner }}">
                </div>
