          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{ url('/admin/about/add') }}" class="btn btn-primary">
                  <i class="fa fa-user mr-2"></i> Add new about us
                </a>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ ++$key }}. </td>
                    <td>{{ $about->heading }}</td>
                    <td><img src="../storage/aboutus/{{ $about->image }}" width="100px" height="50px"></td>
                    <td>{{ Str::limit($about->desc, 100) }}</td>
                    <td style="width: 11rem">
                      <a href="{{ url('/admin/about/edit/'.$about->id) }}" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="{{ url('/admin/about/delete/'.$about->id) }}" class="btn btn-danger btn-sm"><i
