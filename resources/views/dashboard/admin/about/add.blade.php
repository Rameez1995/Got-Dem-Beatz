...
@section('page_title', 'Add About Us')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url('/admin/categories') }}">About Us</a></li>
            ...
            <form action="{{ url('/admin/about/save') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="heading" class="form-control" id="inputTitle" placeholder="Enter title">
                </div>
